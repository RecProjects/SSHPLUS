...
echo -e "\033[1;34m[\033[1;91m•\033[1;34m]\033[1;91m ➩ \033[1;33mREMOVER WEBMIN \033[0;32m"
echo -e "\033[1;34mDeseja Prosseguir? [S/N]: \033[0;32m"; read x
 [[ $x = @(n|N) ]] && msg -bar && return
 fun_bar "apt-get remove webmin -y"
echo -e "\033[1;34m[\033[1;91m•\033[1;34m]\033[1;91m ➩ \033[1;33mREMOVIDO COM SUCESSO \033[0;32m"
 [[ -e /etc/webmin/miniserv.conf ]] && rm /etc/webmin/miniserv.conf
 return 10
 }
echo -e "\033[1;34m[\033[1;91m•\033[1;34m]\033[1;91m ➩ \033[1;33mINSTALAR WEBMIN \033[0;32m"
echo -e "\033[1;34mDeseja Prosseguir? [S/N]: \033[0;32m"; read x
[[ $x = @(n|N) ]] && msg -bar && return
